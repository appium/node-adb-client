...
class USBDevice {
  ...
  async _shell (commandString) {
    ...
    // seems like most shell commands are going to require another read
    // but sometimes we also get an error message back from the _recvMsg
    // and will block at this line
